...
def getMaze(size, enemies):
	if enemies:
		if size == 's':
			...
			# starting_pos = (0, 0)
			# maze = np.array([[b, e, b, b, b, b, b, b, t],
			# 				 [b, w, b, w, w, w, w, w, w],
			# 				 [b, w, e, b, b, b, e, b, b],
			# 				 [b, w, w, w, w, w, w, w, b],
			# 				 [b, w, b, b, b, e, b, b, b],
			...
			starting_pos = (15, 9)
			maze = np.array([[b, b, e, b, b, b, b, b, b, w, b, b, b, b, b, b, b, b, b],
							 [t, w, w, w, b, w, w, w, b, w, b, w, w, w, b, w, w, w, t],
							 [b, w, w, w, b, w, w, w, b, w, b, w, w, w, b, w, w, w, b],
							 [e, b, b, b, b, b, b, b, b, e, b, b, b, b, b, b, b, b, e],
							 ...
							 [w, w, w, w, b, w, b, w, w, w, w, w, b, w, b, w, w, w, w],
							 [b, b, b, e, b, b, b, b, b, w, b, b, b, b, b, b, b, b, b],
							 [b, w, w, w, b, w, w, w, b, w, b, w, w, w, b, w, w, w, b],
							 [t, b, b, w, b, b, b, b, b, b, e, b, b, b, b, w, b, b, t],
